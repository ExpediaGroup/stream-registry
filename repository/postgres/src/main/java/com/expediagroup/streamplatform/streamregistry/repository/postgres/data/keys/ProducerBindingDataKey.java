...
@NoArgsConstructor
@Embeddable
public class ProducerBindingDataKey implements Serializable {
  ...
  public ProducerDataKey getProducerDataKey() {
    return new ProducerDataKey(streamDomain, streamName, streamVersion, infrastructureZone, producerName);
  }
