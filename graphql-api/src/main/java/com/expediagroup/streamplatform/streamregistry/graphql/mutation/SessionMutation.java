...
public interface SessionMutation extends GraphQLApiType {
  Session create(List<ProducerKeyInput> producers, List<ConsumerKeyInput> consumers);
  Session renew(String id, String secret);
}
