...
import static com.expediagroup.streamplatform.streamregistry.app.filters.queryFilters.SpecificationMatchUtility.regex;
...
public class ProducerFilter implements Filter<Producer> {
  ...
  public ProducerFilter(ProducerKeyQuery keyQuery, SpecificationQuery specQuery){this.keyQuery = keyQuery;
