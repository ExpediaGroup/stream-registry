...
public class ConsumerKeyInputConvertor {
  ...
  public static ConsumerKey convert(ConsumerKeyInput consumerKeyInput) {
    return new ConsumerKey(
        consumerKeyInput.getStreamDomain(),
        consumerKeyInput.getStreamName(),
        consumerKeyInput.getStreamVersion(),
        consumerKeyInput.getZone(),
        consumerKeyInput.getName()
    );
  }
}