...
@Data
public class StreamKeyInputConvertor {

  public static StreamKey convert(StreamKeyInput streamKeyInput) {
    return new StreamKey(
        streamKeyInput.getDomain(),
        streamKeyInput.getName(),
        streamKeyInput.getVersion()
    );
  }
}