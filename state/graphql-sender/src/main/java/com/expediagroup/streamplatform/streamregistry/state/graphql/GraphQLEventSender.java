...
public class GraphQLEventSender implements EventSender {
  ...
  private final GraphQLConverter converter;
  ...
  @Override
  public <K extends Entity.Key<S>, S extends Specification> CompletableFuture<Void> send(Event<K, S> entity) {
    var mutation = converter.convert(entity);
