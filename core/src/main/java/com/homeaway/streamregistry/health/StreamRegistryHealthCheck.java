 ...
 */
package com.homeaway.streamregistry.health;

import static com.homeaway.streamregistry.db.dao.AbstractDao.PRIMARY_HINT;
...
import com.homeaway.streamregistry.model.Schema;
import com.homeaway.streamregistry.model.Stream;
import com.homeaway.streamregistry.model.Tags;
import com.homeaway.streamregistry.resource.ConsumerResource;
import com.homeaway.streamregistry.resource.ProducerResource;
...
public class StreamRegistryHealthCheck extends HealthCheck {
    ...
    private Schema createSampleSchema() {
        return com.homeaway.streamregistry.model.Schema.builder()
                .id("1")
                .schemaString("-")
                .version(1).build();
    }
    ...
    private Tags createSampleTags() {
        return com.homeaway.streamregistry.model.Tags.builder()
