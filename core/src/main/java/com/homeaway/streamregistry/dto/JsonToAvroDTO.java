 ...
 */
package com.homeaway.streamregistry.dto;
...
public class JsonToAvroDTO {
    ...
    public static AvroStream convertJsonToAvro(Stream jsonStream, OperationType operationType) {
        ...
        com.homeaway.streamregistry.model.Schema jsonKeySchema = jsonStream.getLatestKeySchema();
        com.homeaway.streamregistry.model.Schema jsonValueSchema = jsonStream.getLatestValueSchema();
        com.homeaway.streamregistry.model.Tags jsonTags = jsonStream.getTags();
