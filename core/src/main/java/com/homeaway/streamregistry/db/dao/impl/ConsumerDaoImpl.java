...
import com.homeaway.streamregistry.exceptions.ConsumerNotFoundException;
...
@Slf4j
public class ConsumerDaoImpl extends AbstractDao implements StreamClientDao<com.homeaway.streamregistry.model.Consumer> {
    ...
    @Override
    public Optional<com.homeaway.streamregistry.model.Consumer> update(String streamName, String actorName, String region) {
        return updateConsumer(streamName, actorName, region);
    }

    @Override
    public Optional<com.homeaway.streamregistry.model.Consumer> get(String streamName, String actorName) {
    ...
    @Override
    public List<com.homeaway.streamregistry.model.Consumer> getAll(String streamName) {
        return getAllConsumers(streamName);
    }

    private Optional<com.homeaway.streamregistry.model.Consumer> updateConsumer(String streamName, String consumerName, String region) {
    ...
    private Optional<com.homeaway.streamregistry.model.Consumer> createConsumer(AvroStream avroStream, String consumerName,
        String region) {
    ...
    private Optional<com.homeaway.streamregistry.model.Consumer> getConsumer(String streamName, String consumerName) {
    ...
    private List<com.homeaway.streamregistry.model.Consumer> getAllConsumers(String streamName) {
        List<com.homeaway.streamregistry.model.Consumer> consumers = new ArrayList<>();
        // pull data from state store of this instance.
