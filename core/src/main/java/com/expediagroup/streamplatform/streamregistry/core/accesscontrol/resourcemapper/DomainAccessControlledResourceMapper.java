...
@Component
public class DomainAccessControlledResourceMapper implements AccessControlledResourceMapper {

  @Override
  public boolean canMap(Object domainObject) {
    return domainObject instanceof Domain;
  }
  ...
  public AccessControlledResource map(Object domainObject) {
    ...
    return new AccessControlledResource(
        Map.of(
            DOMAIN_NAME, domain.getKey().getName()
        ),
        Map.of());
  }
}