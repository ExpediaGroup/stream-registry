 ...
 */
package com.homeaway.streamregistry.utils;
...
public class StreamRegistryUtilsTest {
    ...
    public void testPagination_IdealCase() {
        ...
        List<EntriesPage<Integer>> entriesPages = pages.entrySet()
    ...
    public void testPagination_InvalidPageSizeCase() {
        ...
        EntriesPage<Integer> obtained = entriesPages.get(0);
        EntriesPage<Integer> empty = EntriesPage.<Integer>builder()
                .page(0)
                .pageSize(0)
                .total(0)
