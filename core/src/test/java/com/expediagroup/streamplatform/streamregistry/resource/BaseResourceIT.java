...
import com.expediagroup.streamplatform.streamregistry.StreamRegistryApplication;
import com.expediagroup.streamplatform.streamregistry.StreamRegistryManagedContainer;
import com.expediagroup.streamplatform.streamregistry.configuration.EventStoreTopic;
import com.expediagroup.streamplatform.streamregistry.configuration.HealthCheckStreamConfig;
import com.expediagroup.streamplatform.streamregistry.configuration.KafkaProducerConfig;
import com.expediagroup.streamplatform.streamregistry.configuration.KafkaStreamsConfig;
...
import com.expediagroup.streamplatform.streamregistry.db.dao.impl.StreamDaoImpl;
...
import com.expediagroup.streamplatform.streamregistry.extensions.validator.StreamValidatorIT;
import com.expediagroup.streamplatform.streamregistry.health.EventStoreConfigHealthCheck;
import com.expediagroup.streamplatform.streamregistry.health.StreamRegistryHealthCheck;
...
import com.expediagroup.streamplatform.streamregistry.service.impl.ConsumerServiceImpl;
import com.expediagroup.streamplatform.streamregistry.service.impl.ProducerServiceImpl;
...
public class BaseResourceIT {
    ...
    protected static final int TEST_SLEEP_WAIT_MS = 125;
    ...
    public static void setupApplication() throws Exception {
        ...
        initializeZkClient();
        bootstrapServers = getTestUrl("/expediagroup/test/kafka-key");
        schemaRegistryURL = getTestUrl("/expediagroup/test/schema-registry-key");
