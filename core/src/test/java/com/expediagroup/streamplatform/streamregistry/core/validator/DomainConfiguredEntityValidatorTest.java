...
public class DomainConfiguredEntityValidatorTest {
  ...
  private DomainConfiguredEntityValidator underTest;

  @Before
  public void before() {
    underTest = new DomainConfiguredEntityValidator(domainService);
  }
  ...
  public void domainDoesNotExist() {
    doThrow(IllegalArgumentException.class).when(domainService).get(any());
    underTest.validate(entity, existing);
  }
}
