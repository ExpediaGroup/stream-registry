...
import com.expediagroup.streamplatform.streamregistry.SchemaCompatibility;
...
public class JsonModelBuilder {
    ...
    public static Stream buildJsonStream(String streamName, Integer productId, Optional<String> componentId, String hint, String vpc) {
        ...
        stream.setLatestValueSchema(Schema.builder().id("2").version(2).schemaString("{\"namespace\":\"com.expediagroup\",\"type\":\"record\",\"name\":\"user\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"}]}")
                .created(Calendar.getInstance().getTime().toString())
