...
import static com.expediagroup.streamplatform.streamregistry.utils.JsonModelBuilder.TEST_COMPONENT_ID;
...
public class StreamResourceIT extends BaseResourceIT {
    ...
    public void test_upsertStream_without_vpcList() {
        ...
        topicConfig.put(NO_OF_PARTITIONS, String.valueOf(1));
        topicConfig.put(REPLICATION_FACTOR, String.valueOf(1));
    ...
    public void test_getAllStreamsWithTime() throws InterruptedException {
        ...
        List<Stream> page = ((StreamRegistryUtils.EntriesPage<Stream>) response.getEntity()).getEntries();
