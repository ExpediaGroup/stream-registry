...
- Fix KafkaEventReceiver so `close` no longer causes a `ConcurrentModificationException`
...
## [1.4.0] 2023-03-20
### Removed 
- removing all code which is related to renaming and was added in version `1.1.3` and `1.3.0`
