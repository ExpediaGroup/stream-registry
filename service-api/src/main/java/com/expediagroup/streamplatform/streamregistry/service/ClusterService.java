...
public interface ClusterService {
   ...
   */
  Cluster getCluster(String vpc, String env, String hint, String actorType) throws ClusterNotFoundException;

  /**
   * Upsert cluster.
   *
   * @param cluster the json cluster
   * @throws InvalidClusterException - if the cluster properties are not defined
   */
  void upsertCluster(Cluster cluster) throws InvalidClusterException;
}
